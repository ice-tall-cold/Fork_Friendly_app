...
user_table = User.create(First_Name: 'Sa', Last_Name: 'sankeert', Email: 'ankeerth@tamu.edu',password: 'password',password_confirmation: 'password', Gender: 'Male',Admin: true)
user_table = User.create(First_Name: 'S', Last_Name: 'ankeert', Email: 'nkeerth@tamu.edu',password: 'password',password_confirmation: 'password', Gender: 'Male',Admin: true)
user_table = User.create(First_Name: 'Sa', Last_Name: 'snkeert', Email: 'keerth@tamu.edu',password: 'password',password_confirmation: 'password', Gender: 'Male',Admin: true)
user_table = User.create(First_Name: 'Sa', Last_Name: 'sakeert', Email: 'eerth@tamu.edu',password: 'password',password_confirmation: 'password', Gender: 'Male',Admin: true)
